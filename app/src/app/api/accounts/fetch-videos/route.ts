...
export async function POST(req: Request) {
  ...
  // req.json() throws on Cloudflare Workers (unenv polyfill bug). Use the
  // X-Body header workaround via readBody() — matches pattern across other
  // routes. Client sends ids via header.
