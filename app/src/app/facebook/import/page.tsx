...
const PRESETS: Array<{ name: string; order: FieldKey[] }> = [
  ...
  {
    name: "user | pass | email | 2fa | email_pass | token",
    order: [
      "username",
      "password",
      "email",
  ...
  {
    name: "user | pass | email | 2fa | email_pass | token | note",
    order: [
      "username",
      "password",
      "email",
...
export default function FacebookImportPage() {
  ...
  function addColumn() {
    setOrder((prev) => (prev.length >= 10 ? prev : [...prev, "skip"]));
  }
    ...
    <>
      <header className="page-header">
        <div className="page-header-left">
          <span className="eyebrow">Facebook · Nhập dữ liệu</span>
          <h1 className="h1-serif">
            Import <em>Facebook hàng loạt</em>
          </h1>
        </div>
      ...
      <section className="section">
        <div className="section-head">
          <div>
            ...
            <div className="section-label" style={{ marginTop: 4 }}>
              ...
              một trường dữ liệu (bao gồm cả Token Facebook)
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            là dòng hợp lệ. Token dùng để load fanpage bên{" "}
            <Link
              href="/fanpage"
      ...
      <section className="section">
        ...
        <div style={{ marginTop: 20, display: "flex", gap: 10, flexWrap: "wrap" }}>
          ...
          {preview && validCount > 0 && (
            ...
            >
              Import {validCount} tài khoản Facebook
              {groupId != null &&
          ...
          <div className="section-head">
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              ...
              {preview.duplicatesInInput.length > 0 && (
                <span className="pill">
                  Trùng input {preview.duplicatesInInput.length}
                </span>
              )}
            </div>
          </div>
              ...
              <tbody>
                {preview.rows.map((r) => (
                  <tr key={r.lineNumber} className={!r.valid ? "selected" : ""}>
                    ...
                    <td>
                      {r.token ? (
                        <span className="chip" title={r.token.slice(0, 24) + "…"}>
                          Có
                        </span>
                      ) : (
                        <span className="text-muted">—</span>
